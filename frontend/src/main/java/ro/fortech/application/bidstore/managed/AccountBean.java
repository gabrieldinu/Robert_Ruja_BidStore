package ro.fortech.application.bidstore.managed;

import ro.fortech.application.bidstore.model.UserRole;
...
import ro.fortech.application.bidstore.service.AccountBeanService;
...
public class AccountBean {
    ...
    @Inject
    AccountBeanService accountBeanService;
...
//        query.setParameter("password", PasswordUtils.digestPassword(user.getPassword()));
        UserAuth userAuthentication  = accountBeanService.getAutenticatedUser("admin","password");
...
//    }
    ...
    public AccountBeanService getAccountBeanService() {
        return accountBeanService;
    }
