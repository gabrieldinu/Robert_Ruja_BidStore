...
public interface BiddingService {
    ...
    GenericDTO<ItemDetails> getItemsToSell(GenericDTO<ItemDetails> genericDTO, User user);

    GenericDTO<ItemDetails> getItemsToBuy(GenericDTO<ItemDetails> genericDTO, User user);
